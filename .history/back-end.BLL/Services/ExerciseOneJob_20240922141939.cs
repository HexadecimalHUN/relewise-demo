...
namespace back_end.BLL.Services{
    public class ExerciseOneJob : IJob {
        ...
        public async Task<string> Execute(
            ...
            //Fetching ProductData from the Data Acces Layer
            var productDalaList = await _exerciseOneService.GetProductDataAsync();
            ...
            foreach(var productData in productDalaList){
